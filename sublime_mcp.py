...
_MCP_TOOLS = [
    ...
    ("add_directory",
     "Opens an OS dialog box to prompt for a folder to the 'Where' field in the 'Find in Files' panel. (WindowCommand) Opens a native OS dialog that blocks Sublime Text until it is dismissed.",
     {"type": "object", "properties": {}},
     _p("/add_directory")),
    ("add_jump_record",
    ...
    ("add_word",
     "Adds the given word to the 'added_words' setting in the user preferences. (TextCommand)",
    ...
    ("append",
     ...
     _p("/append")),
    ("auto_complete",
     "Shows the auto completion popup. (TextCommand)",
    ...
    ("build",
     "Executes the provided build system or prompt for selection (select: true) and choose a default. build_system should be a resource path to a build system file or the name of a project-specific build system. (WindowCommand)",
    ...
    ("close_unselected",
     ...
     _p("/close_unselected")),
    ("close_window",
     "Closes the active window. (WindowCommand) Warning: closes the active window (unsaved buffers may prompt).",
     {"type": "object", "properties": {}},
     _p("/close_window")),
    ("close_workspace",
    ...
    ("context_menu",
     "Shows the context menu for the current view. (WindowCommand)",
     {"type": "object", "properties": {}},
     _p("/context_menu")),
    ("copy_as_html",
     "Copies the contents of the current view as rich HTML to the system clipboard. (TextCommand)",
    ...
    ("correct_spelling",
     ...
     _p("/correct_spelling")),
    ("decrease_font_size",
     "Increases the global font size. (ApplicationCommand)",
     {"type": "object", "properties": {}},
     _p("/decrease_font_size")),
    ("delete_file",
     "Deletes the given file(s) by moving the file(s) to the system trash/recycle bin. (WindowCommand) Warning: moves the file(s) to the recycle bin.",
     ...
     _p("/delete_file")),
    ("delete_folder",
     "Deletes the given folder(s) by moving the folder(s) to the system trash bin. (WindowCommand) Warning: moves the folder(s) to the recycle bin.",
    ...
    ("exit",
     "Closes all windows and exists the application. (ApplicationCommand) Warning: quits Sublime Text, which also stops this MCP server.",
     {"type": "object", "properties": {}},
     _p("/exit")),
    ("expand_snippet",
    ...
    ("hide_popup",
     ...
     _p("/hide_popup")),
    ("hot_exit",
     "Saves the session and exits the application even if the 'hot_exit' setting is disabled in preferences. (ApplicationCommand) Warning: quits Sublime Text, which also stops this MCP server.",
     {"type": "object", "properties": {}},
     _p("/hot_exit")),
    ("ignore_word",
     "Adds the given word to the ignored_words setting. (TextCommand)",
    ...
    ("new_os_tab",
     ...
     _p("/new_os_tab")),
    ("new_window",
     "Opens a new ST window. (ApplicationCommand)",
     {"type": "object", "properties": {}},
     _p("/new_window")),
    ...
    ("open_project_or_workspace",
     "Opens the specified project or workspace file, in a new window by default. (WindowCommand)",
    ...
    ("prev_os_tab",
     ...
     _p("/prev_os_tab")),
    ("primary_j_changed",
     "Shows a dialog stating about the change of keybindings for the join_lines command. (WindowCommand)",
     {"type": "object", "properties": {}},
     _p("/primary_j_changed")),
    ("prompt_add_folder",
     "Shows the OS native open dialog, so the user can choose what folder they want to add to the sidebar. (WindowCommand) Opens a native OS dialog that blocks Sublime Text until it is dismissed.",
    ...
    ("prompt_open",
     "Shows the MacOS native open dialog, so that the user can choose what file they want to open. (WindowCommand) Opens a native OS dialog that blocks Sublime Text until it is dismissed.",
     {"type": "object", "properties": {"initial_directory": {"type": "string", "description": "An absolute folder path on disk, where the native dialog will initially open."}}},
     _p("/prompt_open")),
    ("prompt_open_file",
     "Shows the OS native open dialog, so that the user can choose what file they want to open. (WindowCommand) Opens a native OS dialog that blocks Sublime Text until it is dismissed.",
     {"type": "object", "properties": {"initial_directory": {"type": "string", "description": "An absolute folder path on disk, where the native dialog will initially open."}}},
     _p("/prompt_open_file")),
    ("prompt_open_folder",
     "Shows the OS native open dialog, so that the user can choose what folder they want to open. (WindowCommand) Opens a native OS dialog that blocks Sublime Text until it is dismissed.",
     {"type": "object", "properties": {"initial_directory": {"type": "string", "description": "An absolute folder path on disk, where the native dialog will initially open."}}},
     _p("/prompt_open_folder")),
    ("prompt_open_project_or_workspace",
     "Show the OS' native open dialog, so the user can choose what project they want to open. (WindowCommand) Opens a native OS dialog that blocks Sublime Text until it is dismissed.",
     {"type": "object", "properties": {"initial_directory": {"type": "string", "description": "An absolute folder path on disk, where the native dialog will initially open."}}},
     _p("/prompt_open_project_or_workspace")),
    ("prompt_save_as",
     "Show the OS native save as dialog, so the user can choose the path where they want the file to be saved. (WindowCommand) Opens a native OS dialog that blocks Sublime Text until it is dismissed.",
     {"type": "object", "properties": {"initial_directory": {"type": "string", "description": "An absolute folder path on disk, where the native dialog will initially open."}}},
     _p("/prompt_save_as")),
    ("prompt_select_workspace",
     "Opens the Quick Switch Project window. (WindowCommand)",
     {"type": "object", "properties": {}},
     _p("/prompt_select_workspace")),
    ("prompt_switch_project_or_workspace",
     "Show the OS native open dialog, so the user can choose what project they want to switch to. (WindowCommand) Opens a native OS dialog that blocks Sublime Text until it is dismissed.",
     {"type": "object", "properties": {"initial_directory": {"type": "string", "description": "An absolute folder path on disk, where the native dialog will initially open."}}},
     _p("/prompt_switch_project_or_workspace")),
    ("purchase_license",
     "Navigates to the url https://www.sublimehq.com/store/text in the default browser to allow a user to purchase a license.. (ApplicationCommand)",
     {"type": "object", "properties": {}},
     _p("/purchase_license")),
    ("redo_or_repeat",
    ...
    ("remove_license",
     "Removes the license. This will cause Sublime Text/Merge to go into an unregistered state. (ApplicationCommand) Warning: unregisters Sublime Text.",
     {"type": "object", "properties": {}},
     _p("/remove_license")),
    ("rename_path",
     "Renames the given file(s) on disk. (WindowCommand)",
    ...
    ("replace_completion_with_auto_complete",
     "Replaces the most recently inserted completion with the next result provided by the auto completion engine. (TextCommand)",
     {"type": "object", "properties": {}},
    ...
    ("replace_next",
     ...
     _p("/replace_next")),
    ("reset_font_size",
     "Resets the font size to the default value. (ApplicationCommand)",
     {"type": "object", "properties": {}},
     _p("/reset_font_size")),
    ("resize_window",
    ...
    ("run_macro_file",
     ...
     _p("/run_macro_file")),
    ("save",
     "Saves the active view/document. (TextCommand)",
    ...
    ("save_project_and_workspace_as",
     "Opens the OS dialog window to save the active project. (WindowCommand) Opens a native OS dialog that blocks Sublime Text until it is dismissed.",
     {"type": "object", "properties": {}},
     _p("/save_project_and_workspace_as")),
    ("save_workspace_as",
     "Opens the OS dialog window to save the active workspace. (WindowCommand) Opens a native OS dialog that blocks Sublime Text until it is dismissed.",
     {"type": "object", "properties": {}},
    ...
    ("set_build_system",
     ...
     _p("/set_build_system")),
    ("set_file_type",
     "Sets the syntax for the active view. (TextCommand)",
    ...
    ("set_line_ending",
     ...
     _p("/set_line_ending")),
    ("show_about_window",
     "Displays the about dialog. (ApplicationCommand)",
     {"type": "object", "properties": {}},
     _p("/show_about_window")),
    ("show_changelog",
     "Displays the changelog dialog. (ApplicationCommand)",
     {"type": "object", "properties": {}},
     _p("/show_changelog")),
    ("show_license_window",
     "Displays the license dialog. This will only work if you are running an unregistered copy of Sublime Text. (ApplicationCommand)",
     {"type": "object", "properties": {}},
     _p("/show_license_window")),
    ("show_progress_window",
     "Displays the indexing status dialog. (ApplicationCommand)",
     {"type": "object", "properties": {}},
    ...
    ("sublime_merge_blame_file",
     "Git blame selected file(s) with Sublime Merge. (WindowCommand)",
     {"type": "object", "properties": {"files": {"type": "array"}}},
     _p("/sublime_merge_blame_file")),
    ("sublime_merge_file_history",
     "Show the history of the selected file(s) in Sublime Merge. (WindowCommand)",
     {"type": "object", "properties": {"files": {"type": "array"}}},
    ...
    ("toggle_show_open_files",
     "Toggles the visibility of the list of open files in the sidebar. (WindowCommand)",
     {"type": "object", "properties": {}},
    ...
    ("unfold_all",
     ...
     _p("/unfold_all")),
    ("update_check",
     "Opens the update dialog box of Sublime Text. (ApplicationCommand)",
     {"type": "object", "properties": {}},
     _p("/update_check")),
    ("upgrade_license",
